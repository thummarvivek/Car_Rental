<?php
session_start();
$dbh = new mysqli('localhost','root','','carrental');
if(isset($_POST['submit']))
{
    ...
    $exe=$dbh->query( "select * from admin WHERE UserName= '$user' and Password= '$password' ");   
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form action="" method="post">
									...
									<button class="btn btn-primary btn-block" name="submit" id="submit" type="submit" value="Login">LOGIN</button>
